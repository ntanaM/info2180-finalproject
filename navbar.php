<html lang = "en">
    ...
    <aside>
        ...
        <p class="navitext" href="dashboard.html">Home</p>
        <br>

        <img class= "navicons" src="user.png" alt="User picture"">
        <p class="navitext"><a href="contact.html">New Contact</a></p>
        <br>
        <img class= "navicons" src = "group-user.png" alt="Group Contacts">
        <p class="navitext"><a href="logout.php">Users</a></p>

        <hr>

        <img class= "navicons" src="log-out.png" alt="Log out picture">
        <p class="navitext"><a href="login.php">Logout</a></p>
    </aside>
</html>